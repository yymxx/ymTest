    ...
    <el-dialog :title="textMap[dialogStatus]"
      ...
      <el-form :inline="true"
        ...
        <el-form-item label="疾病编号"
          prop="cdNum">
          <el-input v-model="form.cdNum"
            placeholder="请输入名称"
            style="width: 240px;"
            :readonly="isReadonly"></el-input>
        </el-form-item>
        <el-form-item label="慢性病分类"
          prop="cdId">
          <el-input v-model="form.cdId"
            placeholder="请输入名称"
            style="width: 240px;"
            :readonly="isReadonly"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleQuery(currentPage, pageSize) {
      ...
      const apiUrl = allApi.chronicdisease.getList
      getRecordList(apiUrl, {
        page: this.currentPage,
        pageSize: this.pageSize,
        cdName: this.listQuery.nickName,
        cdClassName: this.listQuery.idCard,
    ...
    create(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          const apiUrl = allApi.chronicdisease.addData
    ...
    update(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          this.dialogFormVisible = false
          const apiUrl = allApi.chronicdisease.updateData
    ...
    handleDelete() {
      if (this.mulSelection.length > 0) {
        this.$confirm('此操作将永久删除, 是否继续?', '提示', {
          ...
          const apiUrl = allApi.chronicdisease.delData
