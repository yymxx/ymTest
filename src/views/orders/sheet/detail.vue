    ...
    <div class="sheet-detail">
      <el-form :inline="true"
        ...
        <table width="100%"
          ...
          <tr>
            <td>
              <div class="td-center">工单备注</div>
            </td>
            <td colspan="3">
              <div class="td-box">
                <span>{{ form.wdRemarks }}</span>
              </div>
            </td>
          </tr>
        </table>
        ...
        <el-tabs type="card">
          <el-tab-pane label="服务记录">
            <table width="100%"
              ...
              border="1"
              class="apply-table">
              <tr v-for="(row, num) in basics.give"
                :key="num">
                <td>
                  <div class="td-center">{{ row[1] }}</div>
                </td>
              ...
              <tr>
                <td>
                  <div class="td-center">服务时长</div>
                </td>
                <td colspan="3">
                  <div class="td-box">
                    <span>{{ form.serviceLength }}</span>
                  </div>
                </td>
              </tr>
              <tr>
                <td>
                  <div class="td-center">服务报告</div>
                </td>
                <td colspan="3">
                  <div class="td-box">
                    <div v-if="form.serviceReport"
                      style="margin-bottom: 12px;">{{ form.serviceReport }}</div>
        ...
        <el-tabs type="card"
          v-if="rowData.wdState==6||rowData.wdState==7">
          <el-tab-pane label="回访记录">
            <table width="100%"
              ...
              border="1"
              class="apply-table">
              <tr v-for="(row, num) in basics.visit"
                :key="num">
                <td>
                  <div class="td-center">{{ row[1] }}</div>
                </td>
              ...
              <tr>
                <td>
                  <div class="td-center">回访记录</div>
                </td>
                <td colspan="3">
                  <div class="td-box">
                    <span>{{ form.rvContent }}</span>
                  </div>
                </td>
              </tr>
            </table>
