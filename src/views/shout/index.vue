        ...
        <el-row>
          <el-col :span="6">
            <img :src="imgUrlList[0]"
              class="call-icon" />
            <span>待回访工单</span>
            <strong>{{ form.reserve1 }}</strong>
          </el-col>
          <el-col :span="6">
            <img :src="imgUrlList[1]"
              class="call-icon" />
            <span>待处理任务</span>
            <strong>{{ form.reserve2 }}</strong>
          </el-col>
          <el-col :span="6">
            <img :src="imgUrlList[2]"
              class="call-icon" />
            <span>待处理投诉</span>
            <strong>{{ form.reserve3 }}</strong>
          </el-col>
          <el-col :span="6">
            <img :src="imgUrlList[3]"
              class="call-icon" />
            <span>待处理预警</span>
            <strong>{{ form.reserve4 }}</strong>
          </el-col>
        </el-row>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      timeQuerys: null,
      imgUrlList: [
        './static/images/shout03.png',
        './static/images/shout04.png',
        './static/images/shout05.png',
        './static/images/shout06.png'
      ],
